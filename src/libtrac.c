...
clim_hno3_t get_clim_hno3_init_data(){
    clim_hno3_t clim_hno3_init_data = {
        {
    ...
    return clim_hno3_init_data;
}

/*****************************************************************************/

clim_tropo_t get_clim_tropo_init_data(){
