...
void set_clim_hno3_init_data(clim_t *clim) {
    ...
    memcpy(clim->hno3_secs, hno3_secs, sizeof clim->hno3_secs);

    double hno3_lats[18] = {
            -85, -75, -65, -55, -45, -35, -25, -15, -5,
            5, 15, 25, 35, 45, 55, 65, 75, 85
    };
    memcpy(clim->hno3_lats, hno3_lats, sizeof clim->hno3_lats);

    double hno3_ps[10] = {
            4.64159, 6.81292, 10, 14.678, 21.5443,
            31.6228, 46.4159, 68.1292, 100, 146.78
    };
    memcpy(clim->hno3_ps, hno3_ps, sizeof clim->hno3_ps);
    ...
    memcpy(clim->hno3_var, hno3_var, sizeof clim->hno3_var);
}
...
void set_clim_tropo_init_data(clim_t *clim) {
    ...
    memcpy(clim->tropo_secs, tropo_secs, sizeof clim->tropo_secs);
    ...
    memcpy(clim->tropo_lats, tropo_lats, sizeof clim->tropo_lats);
    ...
    memcpy(clim->tropo_tps, tropo_tps, sizeof clim->tropo_tps);
}
