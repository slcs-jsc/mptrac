...
int main(
  ...
  char *argv[]) {
...

    {
        ...
        intpol_met_time_3d_ap_coord(met0, pressures0, met1, pressures1, time_ap, zeta_ap, lon_ap, lat_ap,    &press,ci_apc,cw_apc,1);
        intpol_met_time_3d         (met0, met0->zeta, met1, met1->zeta, time_ap,   press, lon_ap, lat_ap, &zeta_out,ci   ,cw     ,1);

        printf("%f;%f;%f;%f;%f\n",zeta_ap,press,zeta_out,zeta_out-zeta_ap,met1->zeta_dot[ci[0]][ci[1]][ci[2]]);        
    }
