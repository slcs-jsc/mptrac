...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{   
   double Ynew[10], Fcn0[10], Fcn[10],
      dFdT[10],
      Jac0[45], Ghimj[45];
   double K[10*ros_S];   
   double H, T, Hnew, HC, HG, Fac, Tau; 
   double Err, Yerr[10];
   int Pivot[10], Direction, ioffset, j, istage;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
  ...
  /*~~~>   Compute the stages  */
   for (istage = 1; istage <= ros_S; istage++) {
      ...
      /* Current istage offset. Current istage vector is K[ioffset:ioffset+10-1] */
      ioffset = 10*(istage-1);
	 
      /* For the 1st istage the function has been computed previously */
      if ( istage == 1 )
	   WCOPY(10,Fcn0,1,Fcn,1);
      else { /* istage>1 and a new function evaluation is needed at current istage */
	if ( ros_NewF[istage-1] ) {
	   WCOPY(10,Y,1,Ynew,1);
	   for (j = 1; j <= istage-1; j++)
	     WAXPY(10,ros_A[(istage-1)*(istage-2)/2+j-1],
                   &K[10*(j-1)],1,Ynew,1); 
  ...
  /*~~~>  Compute the new solution   */
   WCOPY(10,Y,1,Ynew,1);
   for (j=1; j<=ros_S; j++)
       WAXPY(10,ros_M[j-1],&K[10*(j-1)],1,Ynew,1);

  /*~~~>  Compute the error estimation   */
   WSCAL(10,ZERO,Yerr,1);
   for (j=1; j<=ros_S; j++)    
       WAXPY(10,ros_E[j-1],&K[10*(j-1)],1,Yerr,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/   
{
  /*~~~> Local variables */     
   ...
   WAXPY(10,(-ONE),Fcn0,1,dFdT,1);
   WSCAL(10,(ONE/Delta),dFdT,1);
...
{   
  ...
  /*~~~>    Construct Ghimj = 1/(H*ham) - Jac0 */
     WCOPY(45,Jac0,1,Ghimj,1);
     WSCAL(45,(-ONE),Ghimj,1);
...
{   
  ...
  /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 10 , NRHS, A, 10, Pivot, b, 10, INFO ) */
