...
$trac/tropo - data/tropo.nc ../data/ei_2011_06_05_00.nc ../data/ei_2011_06_06_00.nc TROPO_DLON 6 TROPO_DLAT 3
...
for var in clp dyn wmo_1st wmo_2nd ; do
    $trac/tropo_sample - data/sample_$var.tab data/tropo.nc $var data/atm.tab
done

# Calculate zonal means...
for var in clp dyn wmo_1st wmo_2nd ; do
    $trac/tropo_zm - data/zm_$var.tab $var data/tropo.nc
done
