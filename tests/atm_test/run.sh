...
$trac/atm_init - data/atm2_2000_01_02_00_00_00.tab \
	       INIT_T0 86400 INIT_T1 86400 \
	       INIT_Z0 30 INIT_Z1 30 INIT_UZ 60 \
	       INIT_ULON 360 INIT_ULAT 180 \
...
# Convert...
$trac/atm_conv - data/atm_2000_01_01_00_00_00.tab 0 data/atm.bin 1 $qnt
$trac/atm_conv - data/atm.bin 1 data/atm_ascii_from_bin.tab 0 $qnt
diff -s data/atm_ascii_from_bin.tab data/atm_2000_01_01_00_00_00.tab || exit 1

$trac/atm_conv - data/atm_2000_01_01_00_00_00.tab 0 data/atm.nc 2 $qnt
$trac/atm_conv - data/atm.nc 2 data/atm_ascii_from_nc.tab 0 $qnt
diff -s data/atm_ascii_from_nc.tab data/atm_2000_01_01_00_00_00.tab || exit 1

# Select...
$trac/atm_select - data/atm_select.tab data/atm_2000_01_01_00_00_00.tab \
...
for param in mean stddev min max skew kurt median absdev mad ; do
    $trac/atm_stat - data/stat_$param.tab $param \
		   data/atm_2000_01_01_00_00_00.tab \
...
for param in mean min max median absdev mad ; do
    ...
    $trac/atm_dist - data/dist_$param.tab $param \
		   data/atm_2000_01_01_00_00_00.tab \
		   data/atm2_2000_01_01_00_00_00.tab \
		   data/atm_2000_01_02_00_00_00.tab \
		   data/atm2_2000_01_02_00_00_00.tab \
...
$trac/atm2grid - data/atm_2000_01_01_00_00_00.tab \
