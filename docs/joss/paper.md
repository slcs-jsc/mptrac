...
MPTRAC is a Lagrangian particle dispersion tool designed to analyze atmospheric transport processes in the free troposphere and stratosphere. It computes air parcel trajectories by solving the kinematic equation of motion, utilizing horizontal wind and vertical velocity fields from global reanalyses or forecasts. A common, high-quality data source for meteorological data is the European Centre for Medium-Range Weather Forecasts (ECMWF) ERA5 reanalysis, which provides detailed and reliable atmospheric data for a wide range of applications. To account for mesoscale diffusion and subgrid-scale wind fluctuations, MPTRAC employs the Langevin equation, introducing stochastic perturbations to the trajectories. Additionally, it features an inter-parcel exchange module to represent air mixing.​
